...
void KVStoreAsyncAccessor::async_read(const std::string& key, int replica_type,
                                      RD_HANDLER handler)
{
    m_strand.post([&, this](){
...
void KVStoreAsyncAccessor::async_write(const std::string& key, int replica_type,
...
void KVStoreAsyncAccessor::async_update(const std::string& key, int replica_type,
                                        const unsigned char* value, const size_t sz,
                                        UP_HANDLER handler)
{
    m_strand.post([&, this](){
...
void KVStoreAsyncAccessor::async_delete(const std::string& key, int replica_type,
                                        DEL_HANDLER handler)
{
    m_strand.post([&, this](){
